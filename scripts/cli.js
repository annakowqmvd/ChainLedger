...
const contractABI = require("../artifacts/contracts/Chainledger.sol/Chainledger.json").abi;

program
    .name("chainledger-cli")
    .description("CLI tool for Chainledger smart contract")
    .version("1.0.0");
