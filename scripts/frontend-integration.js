 ...
 * This file demonstrates how to integrate Chainledger with a web frontend
 */

// For React/Vue/Angular applications
export class ChainledgerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChainledgerClient(provider, contractAddress);
